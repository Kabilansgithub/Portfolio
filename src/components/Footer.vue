...
export default {
    ...
    methods: {
        updateTime() {
            ...
            document.getElementById('current-time').innerText = `IST ${timeString}`;
        }
    }
};
</script>
...
<template>
    <div>
        <!-- Main Content -->
        <div class="relative bg-black text-white h-100 overflow-hidden">
            ...
            <!-- Footer Section -->
            <footer class="absolute bottom-4 left-8 text-gray-400 text-sm">
                <p>Copyright © KABILAN S</p>
            </footer>

            <footer class="absolute bottom-4 right-8 text-gray-400 text-sm">
                <p>Proudly 🇮🇳</p>
            </footer>
...
<style scoped>
@import url('https://fonts.googleapis.com/css2?family=Agu+Display&family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Orbitron:wght@400..900&family=Press+Start+2P&family=Raleway:ital,wght@0,100..900;1,100..900&display=swap');
