        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-6">
                <h2 class="text-4xl font-bold text-white">
                    <span class="text-[#a0ff70]">My Projects</span>
                </h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="project-card rounded-xl overflow-hidden bg-gray-800 shadow-xl shadow-gray-700/50">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4 text-[#a0ff70]">
                            Human Resource Management System (HRMS)
                        </h3>
                        <div class="flex justify-between items-center">
                            <a href="#" class="text-gray-300 hover:text-[#a0ff70] flex items-center">
                            ...
                            <a href="#" class="text-gray-300 hover:text-[#a0ff70]">
